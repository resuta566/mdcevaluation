...
$this->title = 'CCJ Teachers';
$this->params['breadcrumbs'][] = $this->title;
$user = \app\models\User::find()->where(['role' => 30])->andWhere(['department'=> 6])->one();
?>

<div class="card">
    <div class="card-header" data-background-color="blue">
        <h1 class="title"><?= Html::encode($this->title) ?> : DEAN - <?= $user->teacher->fullName?></h1>
        <p class="category">List of <?= Html::encode($this->title) ?> of the Evaluation</p>
        
    </div>
    <div class="card-content">
    <?php echo $this->render('_searchCcj', ['model' => $searchModel]); ?>
    <div>
